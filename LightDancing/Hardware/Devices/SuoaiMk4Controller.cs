...
{
    internal class SuoaiMK4Controller : ILightingControl
    {
        private const int DEVICE_VID = 0x258A;
        private const int DEVICE_PID = 0x0144;
        ...
        public List<USBDeviceBase> InitDevices()
        {
            ...
            if (streams != null && streams.Count > 0)
            {
                ...
                {
                    SuoaiMK4Device keyboard = new SuoaiMK4Device(stream);
    ...
    public class SuoaiMK4Device : USBDeviceBase
    {
        public SuoaiMK4Device(HidStream deviceStream) : base(deviceStream)
        {
        }
        ...
        protected override List<LightingBase> InitDevice()
        {
            ...
            Suoai_MK4 keyboard = new Suoai_MK4(_model);
            hardwares.Add(keyboard);
        ...
        protected override HardwareModel InitModel()
        {
            ...
            return new HardwareModel()
            {
                FirmwareVersion = "NA",
                DeviceID = deviceID,
                USBDeviceType = USBDevices.Suoai_MK4,
                Name = "Suoai MK4"
            };
        }
    }

    public class Suoai_MK4 : LightingBase
    {
        /// <summary>
        ...
        public Suoai_MK4(HardwareModel hardwareModel) : base(KEYBOARD_YAXIS_COUNTS, KEYBOARD_XAXIS_COUNTS, hardwareModel)
        {
        }
        ...
        protected override LightingModel InitModel()
        {
            ...
            return new LightingModel()
            {
                ...
                Type = LightingDevices.Suoai_MK4,
