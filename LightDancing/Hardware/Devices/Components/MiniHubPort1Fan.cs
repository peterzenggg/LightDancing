...
{
    internal class MiniHubPort1Fan : LightingBase
    {
        /// <summary>
        ...
        public MiniHubPort1Fan(int usbport, HardwareModel hardwareModel) : base(KEYBOARD_YAXIS_COUNTS, KEYBOARD_XAXIS_COUNTS, hardwareModel)
        {
        ...
        protected override LightingModel InitModel()
        {
            ...
            return new LightingModel()
            {
                ...
                Type = LightingDevices.Gen7StandardRearFan,
                Name = "Port1 Fan",
            };
        }
