...
{
    internal class Q60Logo : LightingBase
    {
        /// <summary>
        ...
        {
            { Keyboard.LED1,      Tuple.Create(2, 1)  },
            { Keyboard.LED2,      Tuple.Create(1, 0)  },
            { Keyboard.LED3,      Tuple.Create(0, 1)  },
            { Keyboard.LED4,      Tuple.Create(1, 2)  },
        ...
        {
            {1, new List<Keyboard>(){ Keyboard.LED1, Keyboard.LED2, Keyboard.LED3, Keyboard.LED4,
            } },
        };

        public Q60Logo(string usbport, HardwareModel hardwareModel) : base(KEYBOARD_YAXIS_COUNTS, KEYBOARD_XAXIS_COUNTS, hardwareModel)
        {
        ...
        protected override void SetKeyLayout()
        {
            ...
            {
                new List<Keyboard>(){ Keyboard.LED1, Keyboard.LED2, Keyboard.LED3, Keyboard.LED4,  },
            };
        }
