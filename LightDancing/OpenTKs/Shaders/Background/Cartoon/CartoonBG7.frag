...
vec4 CartoonBG7(){
    ...
    float y = sin(index) * 0.02 * low_intensity  + 0.1 ;
        ...
        y = sin(index) * 0.045 * low_intensity  + 0.2 ;
        fill = step(length, y);
        if(color == vec3(0.0)){
        ...
        y = sin(index) * 0.055 * low_intensity  + 0.3 ;
        fill = step(length, y);
        if(color == vec3(0.0)){
        ...
        y = sin(index) * 0.065 * low_intensity + 0.4;
        fill = step(length, y);
        if(color == vec3(0.0)){
        ...
        y = sin(index) * 0.08  * low_intensity + 0.5;
        fill = step(length, y);
        if(color == vec3(0.0)){
